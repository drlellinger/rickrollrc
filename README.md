...
To start rickrollin’ immediately:
    ...
    curl -s -L https://raw.githubusercontent.com/drlellinger/rickrollrc/master/roll.sh | bash

Here is the clandestine command you can give to your friends 😈

    curl -s -L https://bit.ly/2V0u7sg | bash
...
Which essentially just does:
    ...
    echo "alias rickroll='curl -L https://raw.githubusercontent.com/drlellinger/rickrollrc/master/roll.sh | bash'" >> ~/.bash_profile
    echo "alias rickroll='curl -L https://raw.githubusercontent.com/drlellinger/rickrollrc/master/roll.sh | bash'" >> ~/.bashrc
